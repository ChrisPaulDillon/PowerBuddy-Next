...
const DeleteExerciseDialog: React.FC<IProps> = ({workoutExerciseId, note}) => {
    ...
    return(<ModalForm isOpen={isOpen} onClose={onClose} title="Delete Exercise?"><DeleteWorkoutExerciseAlert workoutExerciseId={workoutExerciseId} onClose={onClose}/></ModalForm>)
}
